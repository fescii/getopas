...
urlpatterns = [
    ...
    path('my-newsletters/sections/<int:pk>/', views.user_issue_section_list, name='user_issue_section_list'),
    path('my-newsletters/sections/add/<int:id>', views.create_magazine, name='new_newsletter'),
]