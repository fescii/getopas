...
urlpatterns = [
    ...
    path('my-newsletters/sections/add-section<int:page>', views.add_section, name='add_section'),
    path('my-newsletters/sections/remove-section<int:page>', views.remove_section, name='remove_section')
]