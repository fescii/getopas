...
urlpatterns = [
    ...
    path('edit-article/tags/<int:pk>/', views.edit_article_tags, name='edit_article_tags'),
    path('edit-article/cover/<int:pk>/', views.edit_article_cover, name='edit_article_cover'),
