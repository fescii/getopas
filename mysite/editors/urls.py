...
urlpatterns = [
    ...
    path('my-newsletters/<int:issue>/sections/add-section<int:page>', views.add_section, name='add_section'),
    path('my-newsletters/<int:issue>/sections/remove-section<int:page>', views.remove_section, name='remove_section')
]